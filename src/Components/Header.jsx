...
const Header = () => {
  return (
    <div className="h-[39.5rem] lg:h-full lg:w-[17rem] sm:flex sm:flex-col sm:justify-center sm:w-screen">
      <div className="lg:w-[17rem] sm:w-screen h-[39.5rem] lg:h-[49rem] bg-[#F2EAE1] flex flex-col items-center">
        <div className="lg:overflow-hidden lg:w-[17rem]">
        ...
        <button class="cursor-pointer flex justify-center items-center sm:mt-[2.6rem] lg:mt-[5rem] ml-3 w-[120px] h-[35px] hover:bg-[#FEAF00] transition-colors duration-300 rounded">
            Logout
          </button>
      </div>
    </div>
